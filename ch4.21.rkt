...
(define the-grammar
  '((program (expression) a-program)
    ...
    (expression ("setdynamic" my-identifier "=" expression "during" expression) setdynamic-exp)))
...
(define (setdynamic-val var exp1 body env)
...
(define (value-of exp env)
  (cases expression exp
    ...
    (setdynamic-exp (var exp1 body)
                    (setdynamic-val var exp1 body env))))
