...
(define the-grammar
  '((program (expression) a-program)
    ...
    (expression ("let3" my-identifier "=" expression  my-identifier "=" expression my-identifier "=" expression  "in" expression) let3-exp)
...
(define (apply-cont cont val)
  (cases continuation cont
    ...
    (let3-exp-cont1 (var1 var2 exp2 var3 exp3 body env cont)
                    (value-of/k exp2
                                env
                                (let3-exp-cont2 var2 var3 exp3 body (extend-env var1 val env) cont)))
    (let3-exp-cont2 (var2 var3 exp3 body env cont)
                    (value-of/k exp3
                                env
                                (let3-exp-cont3 var3 body (extend-env var2 val env) cont)))
    (let3-exp-cont3 (var3 body env cont)
                    (value-of/k body
